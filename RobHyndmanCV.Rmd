...
# Research
  ...
  * I currently supervise five PhD students. I have previously supervised an additional 28 PhD students and 3 Masters students.
  ...
  * I have coauthored `r NROW(rjh_packages)` R packages as a result of my research (listed on pages \pageref{packagestart}--\pageref{packageend}). There have been over `r round(sum(rjh_packages$downloads, na.rm=TRUE)/1e6)` million downloads of my packages since 2015 (to `r format(Sys.time(), "%e %B %Y")`).
...
# Major conference presentations
  ...
  * Keynote speaker, *Creating social good for forecasters*, Forecasting for Social Good workshop, Oxford UK, July 2022.
...
I have acquired (in most cases jointly) $`r sprintf("%2.1f", sumgrants/1e6)` million in external research grants since 2000. External research grants over $50,000 are listed below.\vspace*{0.2cm}\enlargethispage*{0.5cm}
...
# Teaching
  ...
  * I have received (with George Athanasopoulos), the 2020 Dean's Award for Innovation in Learning and Teaching, and the 2021 Vice-Chancellor's Award for Innovation in Learning and Teaching.
...
```{r working-papers}
pubs %>%
  filter(type %in% c("report", "manuscript") | is.na(type), is.na(keyword)) %>%
  arrange(issued, author$family)
```

...
pkglist <- c(
  ...
  unique() %>%
  sort()
write_packages_bib(pkglist, file="Rpackages.bib")
```
...
# Research
  ...
  * I have produced `r NROW(packages)` R packages as a result of my research (listed on pages \pageref{packagestart}--\pageref{packageend}) which have been downloaded over 2 million times in the last 12 months.

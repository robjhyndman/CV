...
bibliography_entries("rjhpubs.bib", "PhD thesis", startlabel = "papersstart") %>%
  filter(bibtype == "PhdThesis")
bibliography_entries("rjhpubs.bib", "Books") %>%
  filter(bibtype == "Book")
# Normal articles excluding editorials
bibliography_entries("rjhpubs.bib", "Refereed research papers") %>%
  filter(bibtype == "Article", !(key %in% editorials))
bibliography_entries("rjhpubs.bib", "Book chapters") %>%
  filter(bibtype %in% c("InBook", "InCollection"))
bibliography_entries("rjhpubs.bib", "Papers in refereed conference proceedings") %>%
  filter(bibtype == "InProceedings")
bibliography_entries("rjhpubs.bib", "Working papers under revision or review") %>%
  filter(bibtype %in% c("TechReport", "Unpublished"))
bibliography_entries("rjhpubs.bib", "Book reviews") %>%
  filter(bibtype == "Review")
# Now the editorials
bibliography_entries("rjhpubs.bib", "Editorials", endlabel = "papersend") %>%
  filter(bibtype == "Article", key %in% editorials)
bibliography_entries("rjhreports.bib", "Statistical consulting reports",
  startlabel = "consultingstart", endlabel = "consultingend"
)
# Sort R packages by title, then year.
bibliography_entries("Rpackages.bib", "Software (R packages)",
  sorting = "ty", startlabel = "packagestart", endlabel = "packageend"
)
```

...
\usepackage[style=authoryear-comp, maxnames=99, giveninits=true, terseinits=true, dashed=false, doi=false, isbn=false, bibencoding=utf8, backend=biber]{biblatex}

...
\DeclareBibliographyCategory{cat4}
\DeclareBibliographyCategory{cat5}
\DeclareBibliographyCategory{cat6}
\DeclareBibliographyCategory{cat7}
\DeclareBibliographyCategory{cat8}
\DeclareBibliographyCategory{cat9}
...
\newenvironment{publications}{\label{papersstart}\vspace*{0.2cm}

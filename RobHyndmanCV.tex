...
\info{\faicon{map-marker} & \begin{minipage}[t]{6.5cm}\raggedright Department of Econometrics \& Business Statistics, Monash University,
VIC 3800, Australia.\end{minipage}\\[-0.3cm]%
...
#2 & #1 & #3 & #4\\\ifx#5\empty\else\multicolumn{4}{p{\textwidth}}{\begin{minipage}{\textwidth}\renewcommand{\labelitemi}{{\footnotesize\ding{228}}}\begin{itemize}#5\end{itemize}\end{minipage}}\\\fi}
\def\detailedsection#1{\begin{tabular}{lp{6cm}p{6cm}p{3cm}}#1\end{tabular}}

% Templates for brief entries
% Arguments: what when with
\def\briefitem#1#2#3{#2 & #1 & #3 \\}
\def\briefsection#1{\begin{tabular}{lp{6cm}p{10cm}}#1\end{tabular}}
...
\defbibheading{bib2}{\subsection*{Books}}
...
\printbibliography[category=bib2,heading=bib2]\setcounter{papers}{0}

\defbibheading{bib3}{\subsection*{Refereed research papers}}
...
BHG91,}
\newrefcontext[sorting=ynt]\setcounter{papers}{0}\pagebreak[3]
\printbibliography[category=bib3,heading=bib3]\setcounter{papers}{0}

\defbibheading{bib4}{\subsection*{Book chapters}}
...
AGH95,}
\newrefcontext[sorting=ynt]\setcounter{papers}{0}\pagebreak[3]
\printbibliography[category=bib4,heading=bib4]\setcounter{papers}{0}

\defbibheading{bib5}{\subsection*{Papers in refereed conference proceedings}}
...
NAGS86,}
\newrefcontext[sorting=ynt]\setcounter{papers}{0}\pagebreak[3]
\printbibliography[category=bib5,heading=bib5]\setcounter{papers}{0}

\defbibheading{bib6}{\subsection*{Working papers under revision or review}}
...
hetero06,}
\newrefcontext[sorting=ynt]\setcounter{papers}{0}\pagebreak[3]
\printbibliography[category=bib6,heading=bib6]\setcounter{papers}{0}

\defbibheading{bib7}{\subsection*{Book reviews}}
...
BR96,}
\newrefcontext[sorting=ynt]\setcounter{papers}{0}\pagebreak[3]
\printbibliography[category=bib7,heading=bib7]\setcounter{papers}{0}

\defbibheading{bib8}{\subsection*{Editorials}}
...
IJFeditorial05,}
\newrefcontext[sorting=ynt]\setcounter{papers}{0}\pagebreak[3]
\printbibliography[category=bib8,heading=bib8]\setcounter{papers}{0}

\label{papersend}
\defbibheading{bib9}{\subsection*{Statistical consulting reports}}\label{consultingstart}
...
BH86i,
Hyndman86,}
\newrefcontext[sorting=ynt]\setcounter{papers}{0}\pagebreak[3]\printbibliography[category=bib9,heading=bib9]\setcounter{papers}{0}
\label{consultingend}
\defbibheading{bib10}{\subsection*{Software (R packages)}}\label{packagestart}
...
Rtsibblestats,
Rfable,}
\newrefcontext[sorting=ty]\setcounter{papers}{0}\pagebreak[3]\printbibliography[category=bib10,heading=bib10]\setcounter{papers}{0}
\label{packageend}

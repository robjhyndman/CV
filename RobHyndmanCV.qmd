...
# Research
  ...
  * I currently supervise 2 PhD students. I have supervised to completion 34 PhD students and 3 Masters students.
...
I have acquired (in most cases jointly) $`r sprintf("%2.1f", sumgrants/1e6)` million in external research grants since 2000. External research grants over $`r prettyNum(max_grant, big.mark = ",", scientific = FALSE)` are listed below.
...
# Advisory boards
  ...
  * Member of the Scaling committee, Victorian Tertiary Admissions Centre (1994--2025). This committee is responsible for producing the ATAR for VCE students.
...
1. Hyndman, RJ, and R Killick (`r year`). CRAN Task View: Time Series Analysis. URL <https://cran.r-project.org/view=TimeSeries>
2. Talagala, TD, RJ Hyndman, G Romano (`r year`). CRAN Task View: Anomaly Detection. URL <https://cran.r-project.org/view=AnomalyDetection>

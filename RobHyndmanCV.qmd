...
I have acquired (in most cases jointly) $`r sprintf("%2.1f", sumgrants/1e6)` million in external research grants since 2000. External research grants over $80,000 are listed below.\vspace*{0.2cm}\enlargethispage*{0.5cm}

```{r grantstable, results='asis'}
grants |>
  filter(Amount > 80000, Type == "Research") |>
  mutate(

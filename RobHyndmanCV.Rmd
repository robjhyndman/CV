...
I have acquired (in most cases jointly) about $`r sprintf("%2.1f", sumgrants/1e6)` million in external research grants since 2000. External research grants over $30,000 are listed below.\vspace*{0.2cm}

```{r grantstable, results='asis'}
grants %>%
  filter(Amount > 29999, Type=="Research") %>%
  mutate(
